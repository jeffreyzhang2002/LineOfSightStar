...
public class AddBarrierDisplayMenu extends JFrame
{
	private static final long serialVersionUID = -6334663070247872351L;
	...
	public AddBarrierDisplayMenu(GUI gui)
	{
		this.gui = gui;
		this.barrier = new Line2D.Double(0,0,0,0);
		
		super.setTitle("ADD Barrier");
	...
	private class inputActionListener implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent e) 
		{
			try
			{
				...
				gui.main.fieldContent.selectedBarrier = (Double) barrier;
			...
			{
				gui.main.fieldContent.addBarrier(barrier);
